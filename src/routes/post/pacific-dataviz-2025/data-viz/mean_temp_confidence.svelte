<script>
	...
	const positions = { optimistic: 10, typical: 50, pessimistic: 90 };

	// the two lines for the top label:
	const topLabels = {
		optimistic: { likeliness: 'Best Case', impact: 'Lower Warming' },
		pessimistic: { likeliness: 'Worst Case', impact: 'Higher Warming' },
